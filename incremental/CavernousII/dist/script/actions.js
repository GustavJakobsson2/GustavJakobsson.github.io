...
const actions = [
    ...
    new Action("Mine", 1000, [["Mining", 1.01], ["Speed", 0.2]], completeMine),
    new Action("Mine Travertine", 10000, [["Mining", 1.01], ["Speed", 0.2]], completeMine),
    new Action("Mine Granite", 350000, [["Mining", 1.01], ["Speed", 0.2]], completeMine),
    new Action("Mine Basalt", 4000000, [["Mining", 1.01], ["Speed", 0.2]], completeMine),
    new Action("Mine Chert", 50000000, [["Mining", 1.01], ["Speed", 0.2]], completeMine),
    ...
    new Action("Attack Creature", 1000, [["Combat", 1.01]], completeFight, null, tickFight, combatDuration),
